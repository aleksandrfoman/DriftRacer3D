...
namespace PathCreationEditor {
    ...
    public class PathEditor : Editor {
        ...
        public override void OnInspectorGUI()
        {
            ...
            handlesSize = EditorGUILayout.Slider("Handles Size: ", handlesSize, 0.1f, 5);
        }
        ...
        void DrawHandle (int i) {
            ...
            handlePosition = PathHandle.DrawHandle (handlePosition, bezierPath.Space, isInteractive, handleSize * Vector3.Distance(handlePosition, SceneView.currentDrawingSceneView.camera.transform.position) * handlesSize, cap, handleColours, out handleInputType, i);
